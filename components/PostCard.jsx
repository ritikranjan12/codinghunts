...
const PostCard = ({post}) => {
  return (
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span className=" hover:text-black hover:font-bold inline-block bg-pink-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Continue Reading</span>
      </Link>
    </div>
  </div>
)
